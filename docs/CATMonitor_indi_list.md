...
>
> **版本**: v0.3.2 ｜ **更新日期**: 2026-07-25 ｜ **指标总数**: 204（High 24 / Medium 121 / Low 59）
...
> **指标采集目录**：`internal/metrics` + `configs/metrics.yaml`（默认目录）+ 模块自有 `metrics.yaml` 覆盖；High/Medium + 静态身份默认采、Low 诊断默认不采。
