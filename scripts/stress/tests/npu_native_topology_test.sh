...
EOF
chmod 0755 "$TEST_ROOT/bin/npu-burn" "$TEST_ROOT/bin/lspci"
...
describe(){
  ...
  NPU_BURN_EXECUTABLE="$TEST_ROOT/bin/npu-burn" NPU_BURN_OUTPUT_DIR="$TEST_ROOT/output" NPU_BURN_RUN_CASE=matmul NPU_BURN_GROUP= \
