...
var (
	// CPUOnlyScheme: no GPU/NPU (CPU 22 + Memory 33 + Disk 25 + Network 15 + Chassis 5 = 100)
	CPUOnlyScheme = WeightScheme{CPU: 22, Memory: 33, Disk: 25, GPU: 0, Network: 15, Chassis: 5}

	// Accelerated8CardScheme: 8-card server (CPU 8 + Memory 12 + Disk 10 + GPU 50 + Network 15 + Chassis 5 = 100)
	Accelerated8CardScheme = WeightScheme{CPU: 8, Memory: 12, Disk: 10, GPU: 50, Network: 15, Chassis: 5}

	// Accelerated4CardScheme: 4-card server (same as 8-card for now)
	Accelerated4CardScheme = WeightScheme{CPU: 8, Memory: 12, Disk: 10, GPU: 50, Network: 15, Chassis: 5}
)
